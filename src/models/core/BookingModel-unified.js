...
export class BookingModel {
  ...
  constructor(data = {}) {
    ...
    this.final_payment_paid = Boolean(data.final_payment_paid || data.finalPaymentPaid)
  ...
  toDatabase() {
    const dbData = {
      // Core identification (booking_number, ical_uid auto-generated if needed)
      // ID is auto-generated by database, only include if it exists
      ...(this.id && { id: this.id }),
      // booking_number will be generated by BookingService if not present
      ...(this.booking_number && { booking_number: this.booking_number }),
      ...(this.ical_uid && { ical_uid: this.ical_uid }),
      ...
      contract_generated_at: this._safeToISOString(this.contract_generated_at),
      contract_downloaded_at: this._safeToISOString(this.contract_downloaded_at),
      contract_updated_at: this._safeToISOString(this.contract_updated_at),
      
      deposit_invoice_generated_at: this._safeToISOString(this.deposit_invoice_generated_at),
      deposit_invoice_downloaded_at: this._safeToISOString(this.deposit_invoice_downloaded_at),
      deposit_invoice_updated_at: this._safeToISOString(this.deposit_invoice_updated_at),
      
      deposit_receipt_generated_at: this._safeToISOString(this.deposit_receipt_generated_at),
      deposit_receipt_downloaded_at: this._safeToISOString(this.deposit_receipt_downloaded_at),
      deposit_receipt_updated_at: this._safeToISOString(this.deposit_receipt_updated_at),
      
      balance_invoice_generated_at: this._safeToISOString(this.balance_invoice_generated_at),
      balance_invoice_downloaded_at: this._safeToISOString(this.balance_invoice_downloaded_at),
      balance_invoice_updated_at: this._safeToISOString(this.balance_invoice_updated_at),
      
      balance_receipt_generated_at: this._safeToISOString(this.balance_receipt_generated_at),
      balance_receipt_downloaded_at: this._safeToISOString(this.balance_receipt_downloaded_at),
      balance_receipt_updated_at: this._safeToISOString(this.balance_receipt_updated_at),
      
      handover_notes_generated_at: this._safeToISOString(this.handover_notes_generated_at),
      handover_notes_downloaded_at: this._safeToISOString(this.handover_notes_downloaded_at),
      handover_notes_updated_at: this._safeToISOString(this.handover_notes_updated_at),
      ...
      created_at: this._safeToISOString(this.created_at),
      updated_at: this._safeToISOString(this.updated_at),
  ...
  /**
   * Get or calculate payment status based on individual payment flags
   * @returns {string} Payment status enum value
   */
  getPaymentStatus() {
    // Return existing payment_status if set
    if (this.payment_status && this.payment_status !== PaymentStatus.PENDING) {
      return this.payment_status
    }
    
    // Calculate from individual flags
    if (this.deposit_paid && this.final_payment_paid) {
      return PaymentStatus.FULL_PAYMENT
    } else if (this.deposit_paid) {
  ...
  static fromFrontend(formData, statusData = {}) {
    const mappedData = {
      ...
      payment_status: statusData.paymentStatus,
