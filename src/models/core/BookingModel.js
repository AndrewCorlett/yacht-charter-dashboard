...
export class BookingModel {
  ...
  constructor(data = {}) {
    ...
    this.booking_no = data.booking_no || null // Booking numbers should be generated by BookingService
  ...
  // Removed _generateBookingNumber() - booking numbers are now generated by BookingService using YYWWBCNN format
