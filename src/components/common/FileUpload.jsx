...
function FileUpload({ 
  ...
  const validateFile = (file) => {
    // Support for both document and image files based on acceptedTypes
    const isImageUpload = acceptedTypes.includes('.png') || acceptedTypes.includes('.jpg') || acceptedTypes.includes('.jpeg')
    ...
    if (isImageUpload) {
      ...
      errorMessage = 'Only image files (.png, .jpg, .jpeg, .gif) are allowed.'
    } else {
      // Document file validation (default)
      allowedTypes = [
        'application/pdf',
        'application/msword',
      ...
      errorMessage = 'Only PDF and Word documents (.pdf, .doc, .docx) are allowed.'
    }
