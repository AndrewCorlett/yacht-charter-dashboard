  ...
  const [yachts, setYachts] = useState([
    {
      ...
      status: 'active',
      homePort: 'Monaco',
      images: ['/images/spectre-1.jpg', '/images/spectre-2.jpg'],
      description: 'Luxury motor yacht perfect for day charters and overnight stays.',
      amenities: ['wifi', 'aircon', 'sound_system', 'bbq', 'water_toys', 'tender'],
    ...
    },
    {
      ...
      model: 'V45',
      engines: '2x Volvo Penta D6 435HP',
      maxSpeed: 35,
      cruiseSpeed: 28,
      fuelCapacity: 1800,
      waterCapacity: 400,
      status: 'active',
      homePort: 'Cannes',
      images: ['/images/diskdrive-1.jpg'],
      description: 'Fast and agile sport yacht ideal for active groups.',
      amenities: ['wifi', 'aircon', 'sound_system', 'water_toys'],
    ...
    },
    {
      ...
      model: 'Sun Odyssey 58',
      engines: '1x Yanmar 4JH110HP',
      maxSpeed: 8,
      cruiseSpeed: 6,
      fuelCapacity: 300,
      waterCapacity: 600,
      ...
      images: ['/images/arriva-1.jpg', '/images/arriva-2.jpg', '/images/arriva-3.jpg'],
      description: 'Classic sailing yacht for authentic Mediterranean experiences.',
      amenities: ['wifi', 'sound_system', 'bbq', 'tender'],
